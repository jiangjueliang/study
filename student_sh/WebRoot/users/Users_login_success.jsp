...
<div id="wrapper">
	<div id="header">
		...
		<div id="user_info">
			...
			<div id="logout"><a href="Users_loginOut" onclick="firm()">安全退出</a></div>
		</div>
	</div>
	<div id="navigator">
	...
	<div id="footer">Copyright © 2009-2015 All Rights Reserved Powered By Jiangjueliang</div>
</div>
</body>
